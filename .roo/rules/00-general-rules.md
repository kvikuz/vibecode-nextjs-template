...
- Собирайте приложение с помощью docker, ищите в проекте Dockerfile и используйте его для сборки образа приложения
...
- Если в проекте есть shell-скрипты, автоматизирующие развертывание, используйте их. Например, такой скрипт может называться  `deploy.sh`.
